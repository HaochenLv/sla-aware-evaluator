...
from sla_aware_mvp.domain import EvaluatorConfig, RequestSpec, SLA
from sla_aware_mvp.domain import ViolationKind
...
class EvaluatorTests(unittest.TestCase):
    ...
    def test_continuous_progress_survives_arrival(self):
